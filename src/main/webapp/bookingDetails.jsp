...
<%
bookFlight.flight_booking_id = request.getParameter("flight_id");
bookFlight.ticket_price = Integer.parseInt(request.getParameter("ticket_price"));
bookFlight.flight_name = request.getParameter("name");
%>
<!DOCTYPE html>
<html>
<head>
				...
				<form action="${pageContext.request.contextPath}/payment.jsp"
					...
					<div class="form-group">
						<label for="pname">Passenger Name</label> <input type="text"
							...
							placeholder="Enter name of the passenger(s)">
					</div>
					<div class="form-group">
