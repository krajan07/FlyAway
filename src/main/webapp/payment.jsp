...
<%
	bookFlight.passenger_name = request.getParameter("pname");
	bookFlight.passenger_email= request.getParameter("email");
	bookFlight.passenger_phone= request.getParameter("phone");

    if (bookFlight.passenger_name.equals("")
            || bookFlight.passenger_email.equals("")
            || bookFlight.passenger_phone.equals("")) {
		...
		<section class="row justify-content-center">
			...
			<section class="col-sm-6 col-md-3">
				<form action="${pageContext.request.contextPath}/thank-you.jsp"
					...
					<br>
					<p align="left">
						<span><strong>Total fare = <br> <%=bookFlight.ticket_price%>
								X <%=searchFlight.persons%> persons = Rs.<%=bookFlight.ticket_price*searchFlight.persons%></strong></span>
					</p>
